...
export function QuickUserToggler() {
  ...
  return (<>
    {layoutProps.offcanvas && (<OverlayTrigger
      placement="bottom"
      overlay={<Tooltip id="quick-user-tooltip">Lihat pengguna</Tooltip>}
    >
      <div className="topbar-item">
        <div className="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
          ...
          <>
            ...
            <span className="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hai,</span>
